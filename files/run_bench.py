...
def main(argv):
    ...
    try:
        conn = MySQLdb.connect(host= "10.70.53.10", user="root", db="benchmarking")
	...
	print "Adding annotation to grafana "
        ...
        cmd = 'curl -X POST http://admin:redhat@34.233.15.254:3000/api/annotations -H "Content-Type: application/json" -d \'{"dashboardId":' + "6" + ',"time":' + str(starttime) + ',"isRegion":true,"timeEnd":' + str(endtime) + ',"tags":["' + uid + '"],"text":"' + idstring + '"}\''
